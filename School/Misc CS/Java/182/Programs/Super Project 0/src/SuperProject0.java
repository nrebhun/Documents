package pkgsuper.project.pkg0;

import java.util.*;

public class SuperProject0 {
    ...
    public static char getChar(char min, char max) {
        ...
        System.out.print("Please enter a letter between "+min+" and "+max+": ");
        char s = getChar();
        while(s < min || s > max) {
            System.out.println("That is not between min and max.\nTry again:");
            s = getChar();
    ...
    public static double getDouble(double min, double max) {
        ...
        System.out.print("Please enter a double between "+min+" and "+max+": ");
        double s = getDouble();
        while(s < min || s > max) {
            System.out.println("That is not between min and max.\nTry again:");
            s = getDouble();
    ...
    public static String getString(int min, int max) {
        ...
        System.out.print("Please enter a string between "+min+" and "+max+" characters in length: ");
        String s = getString();
    ...
    public static Boolean numericPrecedenceChecker(String min, String max) {
    ...
    public static void main(String[] args) {
        ...
        userInput = String.valueOf(getInt(iMin, iMax));
